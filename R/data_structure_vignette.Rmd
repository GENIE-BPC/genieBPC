---
title: 'Tutial: GENIE BPC Data Structure'
...
GENIE BPC is comprised of several phenomic (clinical) datasets that include data from the AACR Project GENIE Tier 1 registry, institutions’ tumor registries, manual curation based on institutions’ electronic health records (PRISSMM phenomic data model), and derived variables based on these data elements. The datasets are:
...
This vignette will describe the structure of each dataset.
