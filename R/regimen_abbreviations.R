...
#'
#' A dataset containing the cancer-directed drug regimens and their common names
#'
#' @format A table for cancer-directed drug regimens and their common abbreviations
#' \describe{
