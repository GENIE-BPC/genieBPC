...
```{r, include = FALSE, results = 'hide', eval=genieBPC:::check_synapse_login()}
...
```{r, echo = FALSE, results = 'hide', eval=genieBPC:::check_synapse_login()}
tbl_arguments
```

```{r, echo = FALSE, message = FALSE, warning = FALSE, eval=genieBPC:::check_synapse_login()}
tbl_arguments
```
