---
title: "Tutorial: select_unique_sample"
output: rmarkdown::html_vignette
vignette: >
  %\VignetteIndexEntry{select_unique_sample}
...
tbl_arguments = tibble::tribble(
  ...
  "`sample_data`",       "List of samples collected for each cancer. Defined by ‘cohort_ngs’ object returned by create_analytic_cohort() function. Only required parameter for this function.",
  "`histology`",       "Prioritizes samples of a particular histology. Can take any OncoTree code value (e.g.: “LUAD”, “CRC”). Default is NULL.",
  ...
  gt::gt() %>%
  gt::tab_header(title = "`select_unique_sample()` Function Arguments") %>% 
...
select_unique_sample(
		samples_object = nsclc_stg_iv_adeno$cohort_ngs,
		oncotree_code = "LUAD",
