...
Pull the most recent NSCLC data from Synapse and store in the local environment. 
...
Pull version 1.1 for non-small cell lung cancer and version 1.1 for colorectal cancer data.
...
* As of June 2021, the non-small cell lung cancer (NSCLC) and colorectal cancer (CRC) cohorts are available to access. Future cohorts will include breast, pancreas, prostate and bladder cancers. The breast cancer cohort will be available to access late 2021.
