...
Select unique genomic samples from patients with stage IV NSCLC of histology adenocarcinoma. For patients with multiple samples, the select sample with OncoTree code LUAD. For patients with multiple samples with OncoTree code LUAD, select the metastatic genomic sample. If any patients have multiple metastatic samples with OncoTree code LUAD, take the later of the samples. 
