...
- As of July 2024, all six cancer cohorts — non-small cell lung cancer
  (NSCLC), colorectal cancer (CRC), breast cancer (BrCa), pancreatic
  cancer (PANC), prostate cancer (Prostate), bladder cancer (BLADDER) —
  have undergone consortium data releases. Additionally, the NSCLC and
  CRC cohorts have been released publicly. Future public data releases
  for the remaining cohorts are planned.
