test_that("Test class and length of list for sunburst plot", {
  ...
  plot1 <- drug_regimen_sunburst( data_synapse = nsclc_data$NSCLC_v1.1, data_cohort = cohort,
                                  max_n_regimens = 4)
...
test_that("lines of tx specified", {
  ...
  test1a <- drug_regimen_sunburst(data_synapse = nsclc_data$NSCLC_v1.1,
                                  data_cohort = cohort)
  ...
  test1b <- drug_regimen_sunburst(data_synapse = nsclc_data$NSCLC_v1.1,
                                  data_cohort = cohort,
