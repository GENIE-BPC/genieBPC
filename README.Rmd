...
```{r, echo = FALSE}
xfun::embed_file(here::here("files/BPC_NSCLC_v1.1-consortium_Analytic_Data_Guide.pdf"))
```


```{r, echo = FALSE}
xfun::embed_file(here::here("files/BPC_CRC_v1.1-consortium_Analytic_Data_Guide.pdf"))
```
