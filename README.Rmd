...
[![Codecov test coverage](https://codecov.io/gh/GENIE-BPC/genieBPC/branch/master/graph/badge.svg)](https://codecov.io/gh/GENIE-BPC/genieBPC?branch=master)
<!-- badges: end -->
...
*Select stage IV adenocarcinoma NSCLC diagnoses that were treated with Carboplatin/Pemetrexed or Cisplatin/Pemetrexed with or without Bevacizumab as the first regimen following diagnosis:*
...
*Example of a sunburst plot showing 4 lines of treatment, Highlighting First Treatment Regimen:*
...
- [NSCLC V1.1 Analtyic Data Guide](https://www.synapse.org/#!Synapse:syn23002641)
- [NSCLC V2.1 Analtyic Data Guide](https://www.synapse.org/#!Synapse:syn26008058)
- [CRC V1.1 Analtyic Data Guide](https://www.synapse.org/#!Synapse:syn23764204)
- [CRC V1.2 Analtyic Data Guide](https://www.synapse.org/#!Synapse:syn26077308)
- [BrCa V1.1 Analtyic Data Guide](https://www.synapse.org/#!Synapse:syn26077313)
